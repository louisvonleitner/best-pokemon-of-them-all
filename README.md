...
$\centering \textit{PokeType likelihood} = \sum_{p \in T} c_p$, where $T$ is the set of Pokemon of PokeType $T$ and $p \in T$ signifies that $p$ is a Pokemon of said type. Further, $c_p := $ Catchrate of Pokemon $p$.
